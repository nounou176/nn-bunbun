...
v3.2. The successor ExecPlan is proposed and awaits implementation approval.
MCP remains conditional v3.3 work. No plugin, compiler, external GPT edit,
browser extension, provider connection, environment variable, tunnel, or
learner-data transmission is implemented.
...
| Plan | Status | Outcome |
| --- | --- | --- |
| 2026-08-19-m7-v3-skills-plugin.md | Proposed; implementation approval pending | Prove one repository-owned Skills-only lesson-authoring plugin without an API key, MCP server, browser extension, or runtime AI |
